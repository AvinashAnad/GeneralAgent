...
ErrorCode = Literal[
    ...
    "driver_unavailable",    # cua-driver binary/daemon could not be reached
    "permissions_required",  # OS accessibility/screen recording grant missing
    "app_unavailable",       # requested desktop app/window could not be opened
]
...
class ComputerOutput(BaseModel):
    """Desktop-control payload returned by ComputerSkill."""
