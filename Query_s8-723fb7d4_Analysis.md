# Query Analysis: s8-723fb7d4

## Original User Goal

`use local calculator to calculate 11*11`

Session inspected: `s8-723fb7d4`

Primary session report:

[visible_browser_replay_report_s8-723fb7d4.html](ComputerSkillAssignment/code/state/sessions/s8-723fb7d4/visible_browser_reports/s8-723fb7d4/visible_browser_replay_report_s8-723fb7d4.html)

Browser-folder alias of the same session report:

[visible_browser_replay_report_s8-723fb7d4.html](ComputerSkillAssignment/code/state/sessions/s8-723fb7d4/browser/visible_browser_reports/s8-723fb7d4/visible_browser_replay_report_s8-723fb7d4.html)
...
| n:2 | computer | complete | True | Open the local Calculator app, input 11 * 11, and verify the result is 121. |
