...
class BrowserOutput(BaseModel):
    ...
    Planner's failure routing care about `path`. Assignment 9 adds optional
    browser-session fields so replay can show whether an authenticated
    storage state or persistent profile was involved.
    """
