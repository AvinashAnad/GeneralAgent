...
Available skills:
  ...
  browser            fetch / interact with a SPECIFIC URL through a
                     ...
                     when needed.
                     For targets the user explicitly says are already
                     authenticated or profile-backed, include
                     metadata.browser_profile (a short reusable name)
                     or metadata.storage_state / save_storage_state.
                     For a deliberate manual-login bootstrap, include
                     headless=false and save_storage_state; otherwise
